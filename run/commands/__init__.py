...
# from run.commands.voice import setup_voice_commands  # voice_manager.py 파일 없어서 임시 비활성화
...
async def register_all_commands(bot):
    ...
    # await setup_voice_commands(bot)  # voice_manager.py 파일 없어서 임시 비활성화
...
__all__ = [
    ...
    # 'setup_voice_commands',  # voice_manager.py 파일 없어서 임시 비활성화
]

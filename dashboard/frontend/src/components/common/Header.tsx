        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-2 p-1 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
            ...
            <button
              ...
              className="px-5 py-2 rounded-full text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 transition-all duration-300 flex items-center gap-2"
            >
              <Bell className="w-4 h-4" />
              <span className="relative">
                New
                <span className="absolute -top-1 -right-2 w-2 h-2 bg-debi-primary rounded-full animate-pulse" />
              </span>
            </button>
          </nav>
